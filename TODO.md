> PWA icons missing                 │ public/icons/ doesn't exist, manifest references 3 PNGs — app can't be installed
> PWA service worker not configured │ next.config.ts is empty, @ducanh2912/next-pwa installed but unused  
